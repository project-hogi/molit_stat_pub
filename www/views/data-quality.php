...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation"><a href="#field-tab3" aria-controls="messages" role="tab" data-toggle="tab">진단요소</a></li>
	<li role="presentation"><a href="#field-tab3" aria-controls="messages" role="tab" data-toggle="tab">자체통계품질진단결과평가제</a></li>
</ul>
